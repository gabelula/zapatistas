...
```
cd marcos
mkvirtualenv --no-site-packages marcos
...
```
* * * * * ubuntu bash /home/ubuntu/apps/marcos/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|marcos|tweet|`location`||||
|marcos|facebook|`location`||||
|marcos|email|`location`||||
|marcos|new-comment||||
|marcos|open-share-discuss||||
|marcos|close-share-discuss||||
|marcos|summary-copied||||
|marcos|featured-tweet-action|`action`||``tweet_url``|
|marcos|featured-facebook-action|`action`||``post_url``|
